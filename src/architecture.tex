...
Figure~\ref{fig:picasso} shows the complete PICASSO architecture.

\begin{figure}[ht!]
\centering
\epsfig{file=figs/crossover_new.eps, angle=0, height=0.6\linewidth, clip=}
\caption{\label{fig:picasso} Architecture of Proposed System}
\end{figure}
