...
The maximum possible improvement would occur when we turn refresh completely off. Our scheme is able to achieve within (94\%) of this power saving, without compromising on the accuracy that would result in a refresh-less architecture. 
