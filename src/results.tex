...
\begin{figure}[ht!]
\centering
\epsfig{file=figs/DRAMPower_Improvement_8GB_camready.eps, angle=0, height=0.4\linewidth, width=0.8\linewidth, clip=true trim=}
...
\begin{figure}[ht!]
\centering
\epsfig{file=figs/ActionRecognitionAnalysis_camready.eps, angle=0, height=0.4\linewidth, width=0.85\linewidth, clip=}
