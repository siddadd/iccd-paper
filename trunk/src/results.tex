...
The maximum possible improvement would occur when we turn refresh completely off. Our scheme is able to achieve within (94\%) of this power saving on account of 88\% of the refresh power being eliminated, without compromising on the accuracy that would result in a refresh-less architecture. With the fraction of total power due to refresh continuing to increase with subsequent generations, the savings from REVA are expected to grow as well.
