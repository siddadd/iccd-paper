...
%This technique has been used to effectively exploit a modified version of the standard Partial Array Self Refresh (PASR) hardware mechanism~\cite{Liu2011}.
...
%The recognized object can be further passed to a next level for more detailed recognition. 
